  ...
  try {
    ...
    await conn.query(`
      CREATE TABLE IF NOT EXISTS users (
        ...
        admin_notes TEXT,
        is_test_data TINYINT(1) DEFAULT 0,
    ...
    const migrations = [
      ...
      `ALTER TABLE users ADD COLUMN IF NOT EXISTS is_test_data TINYINT(1) DEFAULT 0`,
      `ALTER TABLE profile_answers ADD COLUMN IF NOT EXISTS marital_home_area VARCHAR(150)`
    ];
