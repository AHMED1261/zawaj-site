...
const ANSWER_FIELDS = [
  ...
  'previously_engaged','previously_engaged_details','widow_duration','last_divorce_date','divorce_count','past_marriage_details',
...
app.post('/api/profile/submit', requireAuth, upload.fields([{name:'personal_photos', maxCount:10}, {name:'id_front', maxCount:1}, {name:'id_back', maxCount:1}]), csrfProtection, async (req, res, next) => {
  try {
    ...
    const conditionallyOptional = new Set([
      ...
      'family_house_living','filled_with_knowledge','has_beard','previously_engaged_details','accepts_with_children','accepts_children_with_father_custody'
